...
output_file_tex.write('\hline\n')
output_file_tex.write('expected signal & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_diboson[0][0], nevt_diboson[0][1], nevt_diboson[1][0], nevt_diboson[1][1]))
output_file_tex.write('$\mathrm{{j}}\\to\PGg$ misid. & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_bkg_jetpho_misid[0][0], nevt_bkg_jetpho_misid[0][1], nevt_bkg_jetpho_misid[1][0], nevt_bkg_jetpho_misid[1][1]))
output_file_tex.write('other irreducible + $\PW\PGg$ & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_bkg_irred[0][0], nevt_bkg_irred[0][1], nevt_bkg_irred[1][0], nevt_bkg_irred[1][1]))
output_file_tex.write('$\PZ\PGg$ & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_bkg_egmisid[0][0], nevt_bkg_egmisid[0][1], nevt_bkg_egmisid[1][0], nevt_bkg_egmisid[1][1]))
output_file_tex.write('\hline\n')
output_file_tex.write('predicted backgrounds & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_sum_mc_bkg[0][0], nevt_sum_mc_bkg[0][1], nevt_sum_mc_bkg[1][0], nevt_sum_mc_bkg[1][1]))
output_file_tex.write('total prediction & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_sum_mc_tot[0][0], nevt_sum_mc_tot[0][1], nevt_sum_mc_tot[1][0], nevt_sum_mc_tot[1][1]))
output_file_tex.write('\hline\n')
output_file_tex.write('data & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_data_obs[0][0], nevt_data_obs[0][1], nevt_data_obs[1][0], nevt_data_obs[1][1]))
output_file_tex.write('\hline\n')
...
output_file_tex.write('\hline\n')
output_file_tex.write('expected signal & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_diboson[2][0], nevt_diboson[2][1], nevt_diboson[3][0], nevt_diboson[3][1]))
output_file_tex.write('$\mathrm{{j}}\\to\PGg$ misid. & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_bkg_jetpho_misid[2][0], nevt_bkg_jetpho_misid[2][1], nevt_bkg_jetpho_misid[3][0], nevt_bkg_jetpho_misid[3][1]))
output_file_tex.write('other irreducible + $\PW\PGg$ & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_bkg_irred[2][0], nevt_bkg_irred[2][1], nevt_bkg_irred[3][0], nevt_bkg_irred[3][1]))
output_file_tex.write('\hline\n')
output_file_tex.write('predicted backgrounds & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_sum_mc_bkg[2][0], nevt_sum_mc_bkg[2][1], nevt_sum_mc_bkg[3][0], nevt_sum_mc_bkg[3][1]))
output_file_tex.write('total prediction & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_sum_mc_tot[2][0], nevt_sum_mc_tot[2][1], nevt_sum_mc_tot[3][0], nevt_sum_mc_tot[3][1]))
output_file_tex.write('\hline\n')
output_file_tex.write('data & ${0:.0f} \\pm {1:.0f}$ & ${2:.0f} \\pm {3:.0f}$\\\\\n'.format(nevt_data_obs[2][0], nevt_data_obs[2][1], nevt_data_obs[3][0], nevt_data_obs[3][1]))
output_file_tex.write('\hline\n')
output_file_tex.write('\end{tabular}\n')
